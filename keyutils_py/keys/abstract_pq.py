...
from keyutils_py.keys.abstract_wrapper_keys import KEMPrivateKey, KEMPublicKey, PQPrivateKey, PQPublicKey
...
class PQSignaturePublicKey(PQPublicKey, ABC):
    ...
    def nist_level(self) -> int:
        """Return the claimed NIST security level as an int."""
