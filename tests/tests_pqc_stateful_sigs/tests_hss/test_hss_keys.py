...
from keyutils_py import generate_key, load_private_key_from_file
...
class TestHSSKeys(unittest.TestCase):
    ...
    def test_load_hss_key_from_file(self):
        ...
        """
        key = load_private_key_from_file(os.path.join(HSS_KEYS_DIR, "hss_lms_sha256_m24_h10_lmots_sha256_n24_w1_l9.pem"))
